export const es = {
  ...
  booking: {
    ...
    waitlist: {
      ...
      question: "Te avisamos si se libera un lugar",
      subtitle: "Dejanos tus datos para {n} el {date}",
      emailLabel: "Email",
      submit: "Anotarme",
      submitting: "Anotando…",
      successTitle: "¡Listo, quedaste anotado!",
      successDescription: "Si se libera un lugar te mandamos un email con el link para reservar.",
    },
  },
  me: {
    title: "Tus reservas",
    ...
    chooseNewTime: "Elegí un nuevo horario",
    noTimesForDate: "No hay horarios para ese día",
    modifyError: "Ese horario ya no está disponible",
...
export const en = {
  ...
  booking: {
    ...
    waitlist: {
      ...
      question: "We'll let you know if a spot opens up",
      subtitle: "Leave your details for {n} on {date}",
      emailLabel: "Email",
      submit: "Join waitlist",
      submitting: "Joining…",
      successTitle: "You're on the list!",
      successDescription: "If a spot opens up, we'll email you a link to book it.",
    },
  },
  me: {
    ...
    noTimesForDate: "No times available that day",
    modifyError: "That time slot is no longer available",
    modified: "Reservation updated",
